...
/* globals Ci, AID_1, AID_2, AID_3, HASH_APP1, HASH_APP2, initRuleParsingTest,
           executRuleParsingTest, run_next_test */
/* exported run_test */
...
function run_test() {
  initRuleParsingTest();
  executRuleParsingTest(GPD_SCENARIO1)
  .then(run_next_test);
}
